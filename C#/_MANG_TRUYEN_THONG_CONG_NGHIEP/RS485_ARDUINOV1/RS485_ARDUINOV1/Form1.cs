...
namespace RS485_ARDUINOV1
{
    public partial class Form1 : Form
    {
        ...
        byte[] bufferData;
        string linkOn = "D:\\C#\\_MANG_TRUYEN_THONG_CONG_NGHIEP\\RS485_ARDUINOV1\\light_on1.png";
        string linkOff = "D:\\C#\\_MANG_TRUYEN_THONG_CONG_NGHIEP\\RS485_ARDUINOV1\\light_off.png";
        public Form1()
        {
            InitializeComponent();
                    ...
                    if (data[0] == slaveAdress[i])
                    {
                        if (data[1] == Enable_Tx_Rx[1])
                        {
                            if (data[2] == formData[1])         // value
                            {
                                ...
                                {
                                    valueSlave3 = BitConverter.ToInt16(data, 3);
                                }
                            }
